...
function bubbleChart() {
  ...
  function splitBubbles(splitByType) {
    ...
    if (splitByType === "gender") {
      ...
      //div.innerHTML = "<p class='intro_info'>There are a total of 1324 circles. Each circle represents 1,000,000 Indians. [<a href='https://en.wikipedia.org/wiki/Demographics_of_India'>https://en.wikipedia.org/wiki/Demographics_of_India</a>]</p>";
  ...
  function showTaxTitles() {
    ...
    var taxGroupLabel = ["People who contribute to income tax", "People who do not contribute to income tax"];
