...
export async function generateMetadata() {
    const content = await getContentBySlug('agentic-coding', 'spec_driven_development/spec_driven_dev_coding_agents');

    return {
        title: content?.title || 'Spec-Driven Development',
        description: content?.summary || 'Control system designs for turning specs into incremental code changes',
    };
}

export default async function SpecDrivenDevCodingAgentsPage() {
    const content = await getContentBySlug('agentic-coding', 'spec_driven_development/spec_driven_dev_coding_agents');
        ...
        <div className="min-h-screen py-12">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="mb-8 lg:hidden">
                    ...
                    >
                        <span>←</span> Back to Spec-Driven Development
                    </Link>
                </div>
