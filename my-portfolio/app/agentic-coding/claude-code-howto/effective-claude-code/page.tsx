...
export async function generateMetadata() {
    const content = await getContentBySlug('agentic-coding', 'claude_code_howto/effective_claude_code');

    return {
        title: content?.title || 'Effective Claude Code',
        description: content?.summary || 'Senior engineer mental models for composable primitives and team workflows',
    };
}

export default async function EffectiveClaudeCodePage() {
    const content = await getContentBySlug('agentic-coding', 'claude_code_howto/effective_claude_code');
