...
export async function generateMetadata() {
    const content = await getContentBySlug('agentic-coding', 'claude_code_howto/claude_code_starter_kit');

    return {
        title: content?.title || 'Claude Code Starter Kit',
        description: content?.summary || 'Quick setup reference and getting started guide',
    };
}

export default async function ClaudeCodeStarterKitPage() {
    const content = await getContentBySlug('agentic-coding', 'claude_code_howto/claude_code_starter_kit');
