...
export async function generateMetadata() {
    const content = await getContentBySlug('agentic-coding', 'claude_code_config/everything_claude_code');

    return {
        title: content?.title || 'Everything Claude Code',
        description: content?.summary || 'Complete configuration reference and setup guide',
    };
}

export default async function EverythingClaudeCodePage() {
    const content = await getContentBySlug('agentic-coding', 'claude_code_config/everything_claude_code');
