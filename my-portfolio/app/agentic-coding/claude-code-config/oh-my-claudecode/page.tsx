...
export async function generateMetadata() {
    const content = await getContentBySlug('agentic-coding', 'claude_code_config/oh_my_claudecode');

    return {
        title: content?.title || 'Oh My Claude Code',
        description: content?.summary || 'Advanced configuration patterns and customization options',
    };
}

export default async function OhMyClaudeCodePage() {
    const content = await getContentBySlug('agentic-coding', 'claude_code_config/oh_my_claudecode');
