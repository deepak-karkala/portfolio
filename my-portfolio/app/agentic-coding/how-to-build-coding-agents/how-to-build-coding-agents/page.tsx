...
export async function generateMetadata() {
    const content = await getContentBySlug('agentic-coding', 'how_to_build_coding_agents/how_to_build_coding_agents');

    return {
        title: content?.title || 'How to Build Coding Agents',
        description: content?.summary || 'Complete playbook covering architecture, training, evals, and observability',
    };
}

export default async function HowToBuildCodingAgentsPage() {
    const content = await getContentBySlug('agentic-coding', 'how_to_build_coding_agents/how_to_build_coding_agents');
