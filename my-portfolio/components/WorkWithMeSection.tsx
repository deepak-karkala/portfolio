...
export default function WorkWithMeSection({ withBorder = true }: WorkWithMeSectionProps) {
    return (
        <section className={`mt-24 pb-16 ${withBorder ? 'border-t border-border pt-16' : ''}`}>
            <div className="max-w-4xl mx-auto px-6 text-center">
                ...
                <div className="flex flex-wrap justify-center gap-4">
                    ...
                    <a
                        ...
                        className="inline-flex items-center gap-2 px-3 py-1.5 text-sm rounded-md bg-primary/10 text-primary hover:bg-[var(--color-accent)] hover:text-white hover:border-transparent transition-colors border border-primary/20 font-medium"
                    >
